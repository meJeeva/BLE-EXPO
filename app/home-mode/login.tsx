  ...
  const handleSubmit = async () => {
    ...
    if (step === 'phone') {
      ...
      try {
        ...
        router.push({ pathname: '/home-mode/otp', params: { identifier: phone.trim(), type: 'phone' } });
      } catch (error: any) {
      ...
      try {
        ...
        router.push({ pathname: '/home-mode/otp', params: { identifier: email.trim(), type: 'email' } });
      } catch (error: any) {
        Alert.alert('Error', error.message || 'Failed to send OTP');
      } finally {
        setLoading(false);
        ...
        step === 'landing' && (
          <>
            ...
            <View style={styles.footer}>
              ...
              <TouchableOpacity onPress={() => router.navigate('/home-mode/createUser')}>
